                            ...
                            <Card key={project.title} className="px-8 pt-8 md:pt-12 pb-0 md:px-10 lg:pt-16 lg:px-20 border-2 border-white/10 sticky top-16">
                                <div className="lg:grid lg:grid-cols-2 lg:gap-16">           
                                    <div className='lg:pb-16'>
                                        ...
                                        <h3 className='font-exception text-2xl mt-2 md:mt-5 md:text-4xl'>{project.title}</h3>
                                        <hr className='border-t-2 border-white/5 mt-4 md:mt-5' />
                                        <ul className='flex flex-col justify-center gap-4 mt-4 md:m-5'>
                                            {
                                                project.results.map((result) => (
                                                    // eslint-disable-next-line react/jsx-key
                                                    <li className='flex items-center gap-2 text-sm  md:text-sm text-white/50'>
                                                        <FaRegCheckCircle color='gray' className='size-2 md:size-4' />
